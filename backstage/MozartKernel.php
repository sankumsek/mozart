...
class MozartKernel extends Symfony\Component\HttpKernel\Kernel
{
	...
	{
		$loader->load(__DIR__.'/../configuration/config_'.$this->getEnvironment().'.yml');
	}
	...
	protected function bootWordpress()
	{
		...
		add_action('deactivate_plugin', [$this, 'clearCache'], 10, 2);
		add_action('activate_plugin', [$this, 'clearCache'], 10, 2);
		add_action("after_switch_theme", [$this, 'clearCache'], 10, 2);
		add_action("switch_theme", [$this, 'clearCache'], 10, 2);
	}
