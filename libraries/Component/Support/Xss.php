...
class Xss
{
   ...
   * @var array
   *
   * @see \Mozart\Component\Support\Xss::filterAdmin()
   */
   ...
   *   valid UTF-8.
   *
   * @see \Mozart\Component\Support\Unicode::validateUtf8()
   *
   ...
   * is desired (so \Mozart\Component\Support\String::checkPlain() is
   * not acceptable).
   *
