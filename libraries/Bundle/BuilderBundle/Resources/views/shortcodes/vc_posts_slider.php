...
if ($type === 'nivo') {
    ...
    $slides_wrap_end = '</div>';
} elseif ($type === 'flexslider' || $type === 'flexslider_fade' || $type === 'flexslider_slide' || $type === 'fading') {
    $el_start = '<li>';
    $el_end = '</li>';
