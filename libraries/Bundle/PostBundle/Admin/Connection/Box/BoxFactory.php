...
namespace Mozart\Bundle\PostBundle\Admin\Connection\Box;

use Mozart\Bundle\PostBundle\Admin\Connection\Factory;

class BoxFactory extends Factory
{
    const NONCE = 'mozart-connection-box-nonce';
     ...
     */
    public function wp_ajax_p2p_box()
    {
        check_ajax_referer(static::NONCE, 'nonce');
